...
class DataSource:
    ...
    def event_get_attr(self, event_id, name):
        ...
        host_country_name, host_country_name_in, host_city, host_type,
    ...
    def person_event_get_attr(self, person_id, country_id, event_id, name):
        ...
        consent_form_filename, id_scan_url, id_scan_filename,
        script_scan_urls, script_scan_filenames, scratch_scan_urls,
        scratch_scan_filenames, languages, diet, room_type, room_share_with,
