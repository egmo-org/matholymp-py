...
* `Python <https://www.python.org/>`_, version 3.10 or later (not
  tested with versions older than 3.13).
...
* `Roundup <http://roundup-tracker.org/>`_ (used to provide a web
  ...
  not used).  Use of the current version of Roundup, 2.6.0 as of this
  ...
  are still present in 2.6.0, so you should consider applying the
